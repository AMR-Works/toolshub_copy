...
import { FileText, Plus, Minus, Trash2, Download, Printer } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex items-center mb-4">
        ...
        <h2 className="text-xl font-semibold text-gray-800 dark:text-white">Invoice Generator</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="text-right space-y-2">
          <p className="text-gray-700 dark:text-gray-200">Subtotal: ${calculateSubtotal().toFixed(2)}</p>
          <div className="flex justify-end items-center">
            <label htmlFor="taxRate" className="mr-2 text-gray-700 dark:text-gray-200">Tax (%):</label>
            <input type="number" id="taxRate" value={taxRate} onChange={(e) => setTaxRate(parseFloat(e.target.value))} className="input-field w-20 text-right" />
          </div>
          <p className="text-gray-700 dark:text-gray-200">Tax Amount: ${calculateTax().toFixed(2)}</p>
